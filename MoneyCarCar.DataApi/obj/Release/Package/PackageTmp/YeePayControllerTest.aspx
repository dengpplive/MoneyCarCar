...
<body>
    ...
    <div>
        ...
        <asp:ListItem Text="22充值 " Value="22"></asp:ListItem>
        ...
        <asp:ListItem Text="35自动转账授权" Value="35"></asp:ListItem>
        <asp:ListItem Text="36单笔业务查询(及时返回)o" Value="36"></asp:ListItem>
        <asp:ListItem Text="37 转账确认" Value="37"></asp:ListItem>
        </asp:RadioButtonList>
        ...
        请求易宝的表单数据：<br />
        <br />
        <asp:TextBox ID="txtReturnValue" runat="server" BackColor="Black" ForeColor="Lime" Height="165px" Rows="20" TextMode="MultiLine" Width="100%"></asp:TextBox>
        <br />
        <br />
        &nbsp;<br />
