...
public partial class YeePayNotifyTest : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            RecordLog("YeePayNotifyTest", "YeePayNotifyTest", true);

            string resp = Request.Form["resp"];//xml
            string sign = Request.Form["sign"]; //签名

            RecordLog("YeePayNotifyTest", "YeePayNotifyTest:resp" + resp, false);
            RecordLog("YeePayNotifyTest", "YeePayNotifyTest:sign" + sign, false);
